...
class UserChangeForm(forms.ModelForm):
	...
	class Meta:
		model = Perfil
		fields = ('dni', 'password', 'nombres', 'apellidos', 'departamento', 'tipo','contacto','email','is_active', 'is_admin', 'activo')
...
class PerfilUserAdmin(UserAdmin):
	...
	list_display = ('dni', 'is_admin')
	list_filter = ('is_admin',)
	fieldsets = (
		(None, {'fields': ('dni', 'password')}),
		('Información Personal', {'fields': ('nombres','apellidos','contacto','email','departamento', 'tipo', 'activo')}),
		('Mas Opciones', {'fields': ('is_admin','is_active')}),		
...
admin.site.register(Perfil, PerfilUserAdmin)
